...
list1 = []  # AI points
list2 = []  # human points
list3 = []  # all points of AI and human
list_all = []  # points in chessboard
...
'''
mark:next_point并不好,一方面不知道自己下在哪里,另一方面不适合判断是否游戏结束
'''
def ai():
    ...
    print("AI 出手位置：",tuple(next_point))       
...
def chessboard():
    win = GraphWin("Gobang Game based on Alpha-Beta MGT", GRID_WIDTH * COLUMN, GRID_WIDTH * ROW)
